    ...
    <form action="{{ route('journal.update', $journal->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('name')is-invalid @enderror" name="name" id="name"
                placeholder="Title" value="{{ old('name',$journal->name) }}" required>
        ...
        <div class="mb-3">
            ...
            placeholder="Image" value="{{ old('image') }}" onchange="loadFile(event)">
            ...
            @enderror
            <small>kosongkan jika tidak mau mengubah foto</small>
        </div>
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('link')is-invalid @enderror" name="link" id="link"
                placeholder="Link google form" value="{{ old('link',$journal->link) }}" required>
        ...
        <div class="form-floating my-3">
            ...
            <input id="feature" type="hidden" name="feature"
                value="{{ old('feature',$journal->feature)}}">
