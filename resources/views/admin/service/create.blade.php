...
<div class="container-fluid px-4">
    ...
    <form action="{{ route('service.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            placeholder="Cover" value="{{ old('image') }}" onchange="loadFile(event)" required>
        ...
        <div class="form-floating my-3">
            <div class="form-floating">
                <textarea class="form-control" placeholder="headline" id="headline" name="headline" style="height: 100px"></textarea>
        ...
        <label for="deskripsi mb-3">deskripsi</label>
        <div class="form-floating my-3">
            @error('deskripsi')
            <div class="alert alert-danger my-3" role="alert">
                {{ $message }}
