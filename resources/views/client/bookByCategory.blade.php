                    ...
                    <div class="service-details-content">
                        ...
                        <div class="row justify-content-center" id="listBook">
                            ...
                            <div class="col-12 col-lg-4 col-md-4 mb-3">
                                <div class="card">
                                    <img src="{{ '/storage/books/'.$book->images[0]->path }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <a href="{{ route('book', $book->slug) }}" class="card-link"><i class="fas fa-search"></i> Lihat Detail</a>
                                    </div>
                                  </div>
                            </div>
                            @endforeach
